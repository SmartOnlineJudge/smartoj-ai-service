...
graph_builder.add_node("language", LanguageNode())
graph_builder.add_node("memory_time_limit", MemoryTimeLimitNode())
graph_builder.add_node("tag", TagNode())
...
graph_builder.set_finish_point("language")
graph_builder.set_finish_point("memory_time_limit")
graph_builder.set_finish_point("tag")
